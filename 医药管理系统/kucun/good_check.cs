...
{
    public partial class good_check : Form
    {
        ...
        private void InitdataGridView1()
        {
            DBHelper D = new DBHelper();
            MySqlConnection M = D.getconn();
            MySqlDataAdapter sda = new MySqlDataAdapter("Select * From sale2 where id =  '"+StockOutRowId+"' and remark = '退货中'", M);
            ...
            for (int m = 0; m < dt.Rows.Count; m++)
            {
                ...
                dataGridView1.Rows[m].Cells[10].Value = dt.Rows[m][13].ToString();
        ...
        private void OK()
        {
            ...
            MySqlConnection M = D.getconn();
            M.Open();
            String Sql = "update sale1 set remark = '退货' where id = '" + StockOutRowId + "'";
            MySqlCommand cmd = new MySqlCommand(Sql, M);
            int j = cmd.ExecuteNonQuery();
            Sql = "update sale1 set remark = '退货' where remark = '退货中'";
            if (state == "通过")
            {
        ...
        private void list_()
        {
            ...
            M1.Open();
            String Sql1 = "select * from sale2 where id = '" + StockOutRowId + "' and state like '%退货%'";
            ...
            try
            {
                ...
                while (reader1.Read())
                {
                    ...
                    commodity.Num = double.Parse(reader1[13].ToString());
        ...
        public void update()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Sql1 = "update sale2 set amount = amount - " + list[i].Num + " where Name = '" + list[i].Name + "' and id = '"+StockOutRowId+"'";
                cmd1 = new MySqlCommand(Sql1, M1);
                cmd1.ExecuteNonQuery();
            }
