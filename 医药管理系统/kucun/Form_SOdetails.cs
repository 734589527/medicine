    ...
    public partial class Form_SOdetails : Form
    {
       ...
       public String salesId = null;
        ...
        private void Initlabel()
        {
            ...
            DBHelper D = new DBHelper();
            MySqlConnection M = D.getconn();
            String Sql = "select * from stockout1 where id = '" + StockOutRowId + "'";
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    zhuangtai = reader[1].ToString();//状态
                    kehu = custom;//客户
                }
        ...
        private void InitdataGridView1()
        {
            DBHelper D = new DBHelper();
            MySqlConnection M = D.getconn();
            MySqlDataAdapter sda = new MySqlDataAdapter("Select * From sale2 where id = (select SaleID from stockout1 where id = '"+StockOutRowId+"')", M);
        ...
        private void OK()
        {
            ...
            MySqlConnection M = D.getconn();
            M.Open();
            String Sql = "update stockout1 set states = '通过' where id = '" + StockOutRowId + "'";
            MySqlCommand cmd = new MySqlCommand(Sql, M);
            ...
            Sql = "update sale1 set state = '通过' where id = '" + salesId + "'";
            cmd = new MySqlCommand(Sql, M);
            cmd.ExecuteNonQuery();
            DialogResult diagorel =
        ...
        private void list_()
        {
            ...
            MySqlConnection M = D.getconn();
            M.Open();
            String Sql = "select * from sale1 where id = (select SaleID from stockout1 where id = '"+StockOutRowId+"')";
            MySqlCommand cmd = new MySqlCommand(Sql, M);
            MySqlDataReader reader = null;
            try
            {
            ...
            M1.Open();
            String Sql1 = "select * from sale2 where id = (select SaleID from stockout1 where id = '" + StockOutRowId + "')";
            ...
            try
            {
                ...
                while (reader1.Read())
                {
                    ...
                    commodity.Data=reader1[6].ToString();
                    commodity.Packnum = commodity.Num /double.Parse( commodity.Pack);
                    list.Add(commodity);
                }
            }
            catch
        ...
        private void NO()
        {
            ...
            MySqlConnection M = D.getconn();
            M.Open();
            String Sql = "update stockout1 set states = '不通过' where id = '" + StockOutRowId + "'";
            MySqlCommand cmd = new MySqlCommand(Sql, M);
            int j = cmd.ExecuteNonQuery();
            if (j == 1)
            {
